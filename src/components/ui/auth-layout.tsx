...
export function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Panel */}
      <div className="relative flex w-[420px] shrink-0 flex-col justify-between overflow-hidden bg-gradient-to-br from-[#1570EF] via-[#0b4ea2] to-[#083b7a] p-10">
        {/* Decorative circles */}
      ...
      <div className="relative flex flex-1 flex-col bg-white">
        ...
        <div className="flex flex-1 flex-col items-center justify-center overflow-y-auto px-11 py-10">
