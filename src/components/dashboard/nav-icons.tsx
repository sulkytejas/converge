...
export function PlacementsIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
...
export function CollegepondLogoIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth={2} {...props}>
